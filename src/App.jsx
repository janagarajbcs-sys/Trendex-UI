...
import MandatoryGoogleLogin from './components/MandatoryGoogleLogin.jsx';
...
function Layout({ children }) {
  ...
  // Show mandatory login after 10 seconds
  useEffect(() => {
    if (!isLoggedIn) {
  ...
  if (!isLoggedIn && showLoginPrompt) {
    return <MandatoryGoogleLogin onLoginSuccess={handleLoginSuccess} />;
  }
      ...
      <header className="app-header">
        ...
        >
          ...
          <button
            ...
            title="Logged in with Google (Click to logout)"
          >
            <svg
              width="24"
              height="24"
