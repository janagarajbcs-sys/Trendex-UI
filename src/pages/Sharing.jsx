  ...
  return (
    <div>
      ...
      <div style={{ opacity: 0.85, marginTop: -6 }}>
        Generate Active & Passive Income Through Network Growth
      </div>
      <div style={{ color: '#00ddeb', marginTop: 6 }}>
      ...
      <div className="binary-graph">
        ...
        <div className="node left">
          <span>👤</span>
          <div className="label">Direct 1</div>
        </div>
        <div className="node right">
          <span>👤</span>
          <div className="label">Direct 2</div>
        </div>
      </div>
      <div className="card">
        ...
        />
        <p>
          <strong>🏆 Total → 80 USDT (₹7,680)</strong>
        </p>
      </div>

      <div className="card" style={{ marginTop: 12 }}>
        <h2 style={{ marginTop: 0, color: '#cfeef3' }}>
      ...
      >
        <Link to="/sharing/cashback" className="btn secondary">
          Cashback & MPR Offer Video
        </Link>
        <Link
          to="/bot"
          className="btn"
        ...
        <Link to="/#join-business" className="btn">
          Join/Subscribe Now →
        </Link>
      </div>
    </div>
