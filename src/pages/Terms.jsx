  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <p>
          Welcome to Trendex AI. These Terms and Conditions ("Terms") govern
          your use of our website, services, and trading automation platform. By
        ...
        <ul>
          <li>
            <strong>"Service"</strong> means the Trendex AI trading automation
            platform and related services.
          </li>
          <li>
            <strong>"User"</strong> means any individual or entity using our
            Service.
          </li>
          <li>
        ...
        <p>
          Trendex AI provides automated trading bots for cryptocurrency markets.
        ...
        <h2>6. Trading Risks</h2>
        <p>
          <strong>IMPORTANT:</strong> Cryptocurrency trading involves
          substantial risk of loss and is not suitable for every investor. Past
          performance does not guarantee future results. You acknowledge that:
        </p>
        <ul>
        ...
        <h2>7. Payment and Subscription</h2>
        <ul>
          <li>Premium services require payment as specified</li>
        ...
        <p>
          ...
          Trendex AI and are protected by copyright, trademark, and other
        ...
        <p>
          To the maximum extent permitted by law, Trendex AI shall not be liable
