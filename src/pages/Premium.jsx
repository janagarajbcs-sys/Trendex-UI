...
export default function Premium() {
  return (
    ...
    <li>It is exclusively designed for the individuals who are a part of Janagaraj Sir's community.</li>
    ...
    <li>If you need to access this more than 7 days, you can request the admin to extend your access. Rs: 499 will be charged per month.</li>
  </ul>
